...
class EventVisualizer {
    ...
    _setupCanvas() {
        ...
        // Maintain pitch aspect ratio (105x68 ≈ 0.647)
        // Allow height to grow, don't hard limit to 500px if width is large
        this._canvas.height = Math.max(container.offsetWidth * 0.65, 525);
    }
